...
*/
    ...
    AW3D.Outfit = function( player ){
        ...
        /*  //  Is better do this with dealocateTextures.js.
        ...
        // "aparts" has renamed to "outfits".
            ...
            setGender: function( gender ){
                ...
                store.set( userSettings.gender, gender );
                this.AnimationsHandler.refresh();
            },
            ...
            resetGender: function(){
                ...
                store.set( userSettings.gender, null );
                this.AnimationsHandler.refresh();
            },
...
//  from external source. For internal assets, the native threejs add() method 
...
//  When you are ready to add player to scene:
