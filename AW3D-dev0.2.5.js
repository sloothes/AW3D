    ...
    AW3D.Outfit = function( player ){
        ...
        //  scene.remove() always returns "undefined" (does not throw error).
            ...
            //  var self = this;
                ...
                //  Dispose geometry.
                    if ( !!this[ name ] ) {
                        var geometry = this[ name ].geometry;
                        geometry.dispose();
                    }
        ...
        //  Models.
            ...
            //  Direction scale.
                switch ( this.getGender() ){
                    ...
                    default:
                        this.direction.scale.set(1.04, 1.04, 1.04);
                }
...
*/
    ...
    //  Outfit EventDispatcher.
        ...
        outfit.addEventListener("outfitloadend", function(e){
            console.log("DEPRECATED:", 
                "custom event \"outfitloadend\" is deprecated.",
                "Use instead \"loadend\" custom event."
            );
        });
