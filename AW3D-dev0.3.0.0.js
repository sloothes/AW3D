...
*/
    ...
    AW3D.Outfit = function( player ){
        ...
        /*
            outfits: console.warn(`AW3D.Outfit:
                "outfits" has been renamed to "slots".
                "bra" has been removed.
                "boxers" has been removed.
                "panties" has been removed.
                "lingerie" has been removed.
                "stocking" has been replaced by "stockings".
                "jeans" has been removed.
                "hat" has been added.
                "glasses" has been added.
                "underwears" has been added.
            `),
        */
...
*/
    ...
    //  oufit.AnimationsHandler.
        ...
        //  "outfits" has renamed to "slots".
            player.outfit.slots.forEach( function(name, i){
                if ( !!player.outfit[ name ] ){
...
/*
    ...
    //  When .fromDNA finish...
        for (var i = 0; i < player.outfit.slots.length; i++) {
            var name = player.outfit.slots[i];
            if ( !!player.outfit[ name ] ) {
...
//  .toDNA (v1) prototype.
    ...
    toDNA: function(){
        ...
        player.outfit.slots.forEach( function( name ){
            if ( !!player.outfit[ name ] ) {
                dna[ name ] = {};
                dna[ name ].name      = name;
...
*/
    ...
    /*
        ...
        for (var i = 0; i < outfit.slots.length; i++) {
            var name = outfit.slots[i];
